...
function Card({ card }) {
    return (
        <div className="md:flex bg-azulClaro rounded-xl my-5 mx-3 shadow-md">
            <div className="md:shrink-0">
                <img className="h-48 w-full object-cover rounded-t-xl md:h-full md:w-48 md:rounded-t-none md:rounded-l-xl" src={card.imagem} alt="Logo da fiap faculdade" />
            </div>
